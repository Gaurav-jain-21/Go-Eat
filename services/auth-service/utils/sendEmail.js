...
<head>
  <style>
    ...
    .btn { display:inline-block; background:#1D9E75; color:#fff; padding:12px 28px;
...
<body>
  <div class="container">
    <div class="header"><h1>🍔 Go-Eat</h1></div>
    <div class="body">
      <h2>${title}</h2>
      ${body}
    </div>
    <div class="footer">© 2024 Go-Eat. All rights reserved.</div>
  </div>
</body>
</html>`;
...
const sendEmail = async ({ to, subject, title, body }) => {
  try {
    await transporter.sendMail({
      from: `"Go-Eat" <${process.env.EMAIL_USER}>`,
      to,
      subject,
